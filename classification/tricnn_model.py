...
class TriCNN(nn.Module):
    # Change input_channels depending on PCA or not
    def __init__(self, input_img_size, input_channels, filters, num_classes):
        super().__init__()
        ...
        self.spectralBranch = Branch(
            input_channels, filters, (1, 1, 1, 3), pad=(0, 0, 0, 1))
        self.spatialSpectralBranch = Branch(
            input_channels, filters, (3, 3, 3, 3), pad=(0, 0, 0, 1))
...
class TriCNN_Lightning(pl.LightningModule):
    def __init__(
        ...
        super().__init__()
        self.model = TriCNN(
            input_image_size, input_channels, filters, num_classes)
